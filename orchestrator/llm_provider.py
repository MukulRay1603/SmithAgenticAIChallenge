...
Set CARGO_LLM_PRIORITY to change order, e.g. "openai,ollama"
...
_PRIORITY = os.environ.get("CARGO_LLM_PRIORITY", "ollama,openai,anthropic").split(",")
...
def get_llm(force_refresh: bool = False):
    ...
    priority = os.environ.get("CARGO_LLM_PRIORITY", "ollama,openai,anthropic").split(",")
